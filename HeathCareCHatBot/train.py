...
GREETING_RESPONSES = [
    ...
    "hi there,are you having any health issues?(Y/N)",
    "hello,are you having any health issues?(Y/N)",
    "I am glad! You are talking to me,are you having any health issues?(Y/N)",
]
Basic_Q = ("yes", "y")
...
def chat(user_response):
    ...
    if user_response != "bye":
        ...
        if user_response == "thanks" or user_response == "thank you":
            ...
            if (
                user_response.find(keyword) != -1
                or user_response.find(keywordone) != -1
